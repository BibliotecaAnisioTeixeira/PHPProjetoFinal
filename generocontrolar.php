...
<tr><th>Id</th><th>Nome<th colspan="2">Ações</td></tr>
	...
	<?php
	  while($row = $result->fetch_assoc()) {
		...
		echo "<td><a href='generoeditarform.php?id=" . $row["id"] . "'><img src='./imagens/editar.png' alt='Editar Usuário'></a></td><td><a href='generoexcluir.php?id=" . $row["id"] . "'><img src='./imagens/excluir.png' alt='Excluir Usuário'></a></td></tr>";
	  }
	?>
    ...
    <?php for($i=1; $i <= $contagem; $i++) {
            echo "<a href='generocontrolar.php?pag=$i'>$i</a>";
    } 
	?>   
</div> 
   
			<a href="generocadastrarform.php"><img src='./imagens/incluir.png' alt='Editar Usuário'></a>
</div>
